...
if text == 'معلومات السيرفر 📡'and Sudo_id(msg) then
  ioserver =  io.popen([[
...
----------------------------------------------------------
if text == 'تفعيل تاك للكل' and Constructor(msg) then  
  send(msg.chat_id_, msg.id_, '⌔︙ تم تفعيل التاك للكل')
  redis:del('GLOBLA:'..bot_id..'lock:tag:all')
  end
  if text == 'تعطيل تاك للكل' and Constructor(msg) then  
  send(msg.chat_id_, msg.id_, '⌔︙ تم تعطيل التاك للكل')
  redis:set('GLOBLA:'..bot_id..'lock:tag:all', true)
  end
----------------------------------------------------------
if text == 'تفعيل الوضع الخدمي' and Sudo_id(msg) then  
send(msg.chat_id_, msg.id_, '⌔︙ تم تفعيل الوضع الخدمي')
...
----------------------------------------------------------
if text == "all" or text == "@all" and Mod(msg) then
  if not redis:get('GLOBLA:'..bot_id..'lock:tag:all'..msg.chat_id_) then
  if redis:get('GLOBLA:'..bot_id.."tag:all"..msg.chat_id_..':'..msg.sender_user_id_) then  
  return 
  send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
  end
  redis:setex('GLOBLA:'..bot_id..'tag:all'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
